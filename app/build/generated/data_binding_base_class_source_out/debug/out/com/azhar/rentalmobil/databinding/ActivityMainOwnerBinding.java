...
public final class ActivityMainOwnerBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityMainOwnerBinding(@NonNull RelativeLayout rootView, @NonNull Button btnInfoMobil,
      @NonNull MaterialCardView cvDate, @NonNull FrameLayout flMain, @NonNull ImageView icon,
      @NonNull ImageView imgDate, @NonNull LinearLayout llCurved, @NonNull RelativeLayout rlAppName,
      @NonNull TextView tvDate, @NonNull TextView tvMainSalam) {
  ...
  @NonNull
  public static ActivityMainOwnerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainOwnerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_owner, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainOwnerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainOwnerBinding((RelativeLayout) rootView, btnInfoMobil, cvDate, flMain,
          icon, imgDate, llCurved, rlAppName, tvDate, tvMainSalam);
    }
